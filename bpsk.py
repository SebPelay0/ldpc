        ...
        while numIterations < 10:
            ...
            for j in range(int(self.m)):  
                ...
                for target in Ej:
                    ...
                    # Remove when not using punctured 5G
                    validIndices = excludeTarget
                    minLLR = numpy.min(numpy.abs(bitNodes[validIndices]))
                    signs = numpy.sign(bitNodes[validIndices])
                    signs[signs == 0.0] = 1
